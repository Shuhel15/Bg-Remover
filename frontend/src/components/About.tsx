      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-square max-w-130 border border-white/10">
              ...
              {/* Corner */}
              <div className="pointer-events-none absolute right-7 top-7 h-12 w-12 border-r border-t border-cyan-400/50" />
          ...
          >
            ...
            <h2 className="text-4xl font-black leading-none tracking-[-0.04em] sm:text-6xl">
              ...
              should stay
              <br />
              <span className="text-white/30">out of your way.</span>
            </h2>

            <p className="mt-8 max-w-xl text-base leading-7 text-white/40">
              BG.REMOVER is built around a straightforward idea: background
              removal should not require a complicated editor or a long
              workflow.
            </p>

            <p className="mt-5 max-w-xl text-base leading-7 text-white/40">
              Upload your image, remove what you don&apos;t need and continue
              creating.
            </p>
          </motion.div>
        </div>
